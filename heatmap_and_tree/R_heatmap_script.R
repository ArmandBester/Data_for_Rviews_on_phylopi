...
aln <- read.alignment('output/HBYBVTJX-example/HBYBVTJX-example-mafft_trimal.cleaned.aln', format = 'fasta')
...
qSample <- names(read.fasta("input/HBYBVTJX-example.fasta"))
...
write.csv(alnDist,"/var/www/cgi-bin/phylophile/output/HBYBVTJX-example/HBYBVTJX-example_heatmap.csv")
write.csv(alnDistDedup,"/var/www/cgi-bin/phylophile/output/HBYBVTJX-example/HBYBVTJX-example_dists.csv", row.names = FALSE)
htmlwidgets::saveWidget(as_widget(p), '/var/www/cgi-bin/phylophile/output/HBYBVTJX-example/HBYBVTJX-example_heatmap.html')