...
In a nutshell, the authors looked at how quasispecies are transmitted and they found that there exists a selection bias towards more replicative fit viruses.  As we can see in our tree and heatmap, these viral sequences are genetically very similar.  The authors used multiple samples for many of the patients and we will notice this relatedness by doing these kinds of genetic analysis.
